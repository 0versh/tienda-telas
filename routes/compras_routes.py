...
def nueva():
    ...
    tipos = ProductoModel.obtener_tipos()  # para modal nuevo producto
    return render_template('compras/nueva.html', proveedores=proveedores, telas=telas, colores=colores, tipos=tipos)
